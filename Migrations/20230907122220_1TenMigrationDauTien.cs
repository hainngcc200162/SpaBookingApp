...
{
    /// <inheritdoc />
    public partial class _1TenMigrationDauTien : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfExecutions = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RemainingExecutions = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProvisionBookings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProvisionBookings_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProvisionBookings_Provisions_ProvisionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProvisionBookings_BookingId",
                table: "ProvisionBookings",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_ProvisionBookings_ProvisionId",
                table: "ProvisionBookings",
                column: "ProvisionId");
