...
namespace SpaBookingApp.Controllers
{
    ...
    public class StaffController : ControllerBase
    {
        ...
        {
            var response = await _staffService.DeleteStaffMember(id);
            if (response.Data is null)
            {
                return NotFound(response);
            }
