...
function renderTable(bookings) {
    ...
    for (const booking of bookings) {
        ...
        row.innerHTML = `
                ...
                <td>
                    <a href="/UserManagement/GetBookingById?id=${booking.id}"><i class="fa-solid fa-circle-info fa-xl" style="color: #384971;"></i></a>
                </td>
                <td>
                    <a href="/UserManagement/UpdateBookingByCus?id=${booking.id}"><i class="fa-regular fa-pen-to-square fa-xl" style="color: #1e2f4d;"></i></a>
                </td>
            `;
