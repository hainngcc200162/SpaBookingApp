document.getElementById("deleteProvisionForm").addEventListener("submit", function (event) {
    ...
    axios.delete(`/api/Provision/${provisionId}`, {
        headers: {
        ...
        .then((response) => {
            if (response.data.success) {
                // Xử lý thành công, ví dụ: hiển thị thông báo, chuyển hướng trang, làm mới danh sách dịch vụ, v.v.
                alert("Provision deleted successfully");
